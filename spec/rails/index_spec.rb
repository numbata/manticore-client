...
RSpec.describe ManticoreRails::Index do
  ...
  describe "#add_field" do
    it "adds a Field to the fields list" do
      ...
      expect(index.fields.first).to be_a(ManticoreRails::Field)
  ...
  describe "#add_attribute" do
    it "adds an Attribute to the attributes list" do
      ...
      expect(index.attributes.first).to be_a(ManticoreRails::Attribute)
...
RSpec.describe ManticoreRails::Field do
...
RSpec.describe ManticoreRails::Attribute do
